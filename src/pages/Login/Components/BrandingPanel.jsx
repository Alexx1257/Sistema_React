...
const BrandingPanel = () => {
    return (
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-ui-primary to-sidebar-backgroundEnd p-16 flex-col justify-between text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="w-20 h-1.5 bg-ui-accent mb-8 rounded-full"></div>
                <p className="text-blue-100 text-xl leading-relaxed max-w-sm opacity-90 font-light">
                    Plataforma centralizada para el control operativo del Departamento de
                    Informática.
                </p>
            </div>
